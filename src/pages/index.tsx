...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Vehicle Financing Application v1`}</title>

        <meta
          name="description"
          content="Experience smooth sailing with Vehicle Financing Application v1 - Instant vehicle loans, easy processing, fast approvals, flexible EMIs, and instant disbursal with 100% on-road price funding. Your ride, your rules."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1610647752706-3bb12232b3ab?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx2ZWhpY2xlJTIwbG9hbnxlbnwwfHx8fDE2OTU4NzU5Mzl8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`Vehicle Financing Application v1`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience smooth sailing with Vehicle Financing Application v1 - Instant vehicle loans, easy processing, fast approvals, flexible EMIs, and instant disbursal with 100% on-road price funding. Your ride, your rules.`}
            </Text>
            <Box
